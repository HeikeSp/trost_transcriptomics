...
plants_mart_22=useMart("plants_mart_22")
listDatasets(plants_mart_22)

stu_ensembl = useMart( "plants_mart_22", dataset = "stuberosum_eg_gene" )
...
pca_res <- pca(t(assay(rld)), center=T, scale="none", nPcs=5, method="rnipals")
pca_res@R2
...
cols <- c(rgb(ramp, 0, 0),
          ...
          rgb(ramp, 0, ramp),
          rgb(0, ramp, 0))
print( plotPCA( rld_greenhouse, intgroup = c( "cultivar", "condition"), col=cols ) )
...
rld_greenhouse_agg <- func_agg_2fac(t(assay(rld_greenhouse)), samplelist_ordered_g, "condition", "cultivar", mean)
...
cols <- c(rgb(ramp, 0, 0),
          ...
          rgb(ramp, 0, ramp),
          rgb(0, ramp, 0))
print( plotPCA( rld_field, intgroup = c( "cultivar", "condition"), col=cols ) )

cols <- c(rgb(ramp, 0, 0),
          rgb(0, 0, ramp),
          rgb(0, ramp, 0))
print( plotPCA( rld_field, intgroup = c( "trial", "condition"), col=cols ) )
...
rld_field_agg <- func_agg_2fac(t(assay(rld_field)), samplelist_ordered_g, "condition", "cultivar", mean)
dim(rld_field_agg)
...
plotMA(res_greenhouse_1, ylim=c(-5, 5))
...
cols <- c(rgb(ramp, 0, 0),
          ...
          rgb(ramp, 0, ramp),
          rgb(0, ramp, 0))
print( plotPCA( rld_greenhouse_1, intgroup = c( "cultivar", "condition"), col=cols ) )
...
plotMA(res_greenhouse_2, ylim=c(-3, 3))
...
cols <- c(rgb(ramp, 0, 0),
          ...
          rgb(ramp, 0, ramp),
          rgb(0, ramp, 0))
print( plotPCA( rld_greenhouse_2, intgroup = c( "cultivar", "condition"), col=cols ) )
...
```{r}
counts_keep[1,9:16]
head(assays(dds_greenhouse)$counts)
head(assays(dds_greenhouse)$mu)

assays(dds_greenhouse_1)$mu[638,]
```
