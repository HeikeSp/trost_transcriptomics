...
pdf("figures/corto_greenhouse_strict.pdf", width=11, height=15)
...
pdf("figures/corto_field_strict.pdf", width=12, height=9)
...
pdf("figures/corto_tolerance_strict.pdf", width=16, height=14)
