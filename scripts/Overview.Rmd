...
getwd()
#setwd("/mnt/winhome/TROST/Sequencing/data")
setwd("TROST/Sequencing/Publication/scripts/")
```
...
assoc_pgsc <- read.table("../../data/pgsc_data/PGSC_DM_v3.4_g2t2c2p2func_edit.txt")
head(assoc_pgsc)
...
fpkm_row_mean <- apply(fpkm_genes, 1, mean) # calculate row mean
