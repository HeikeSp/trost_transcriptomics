...
# venn diagram
venn.plot=func_venn_diagram_2(rownames(res_greenhouse_tolerant$top_sig_up), 
...
venn.plot=func_venn_diagram_2(rownames(res_greenhouse_sensitive$top_sig_up), 
                              rownames(res_field_sensitive$top_sig_up), 
                              lab1="Greenhouse", lab2="Field", filepath=NULL)
plot.new()
grid.draw(venn.plot)
...
venn.plot=func_venn_diagram_2(rownames(res_greenhouse_sensitive$top_sig_down), 
                              rownames(res_field_sensitive$top_sig_down), 
                              lab1="Greenhouse", lab2="Field", filepath=NULL)
plot.new()
grid.draw(venn.plot)
```
...
venn.plot=func_venn_diagram_2(rownames(res_greenhouse_tolerant$top_sig_up), 
                              ...
                              lab1="Tolerant", lab2="Sensitive", filepath=NULL)
plot.new()
grid.draw(venn.plot)
...
# venn diagram
venn.plot=func_venn_diagram_2(rownames(res_greenhouse_tolerant$top_sig_down), 
...
# venn diagram
venn.plot=func_venn_diagram_2(rownames(res_field_tolerant$top_sig_down), 
                              rownames(res_field_sensitive$top_sig_down), 
                              lab1="Tolerant", lab2="Sensitive", filepath=NULL)
plot.new()
grid.draw(venn.plot)
...
dim(res_greenhouse_merge_down_sig)
head(res_greenhouse_merge_down_sig)
